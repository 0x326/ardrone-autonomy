...
EKF.prototype.predict = function(navdata) {
    ...
    try {
        var pitch = toRad(navdata.demo.rotation.pitch),
            roll  = toRad(navdata.demo.rotation.roll),
            yaw   = normAngle(toRad(navdata.magneto.heading.fusionUnwrapped)),
